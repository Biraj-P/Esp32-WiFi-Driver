 ...
 * @param arg data is the data, aside from event data, that is passed to the handler when it is called
 * @param event_base is the base id of the event to register the handler for
 * @param event_id is the id for the event to register the handler for
...
static void wifi_app_soft_ap_config(void)
{
    ...
    ESP_ERROR_CHECK(esp_wifi_set_bandwidth(ESP_IF_WIFI_AP, WIFI_AP_BANDWIDTH));     //Our default bandwidth of 20 MHz
